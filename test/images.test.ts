...
// Intercept the provider so nothing reaches the network.
...
const openaiMod: any = await import('../src/providers/openai.ts');
const anthropicMod: any = await import('../src/providers/anthropic.ts');
