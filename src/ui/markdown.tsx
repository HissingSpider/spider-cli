...
const KEYWORDS = new Set([
  ...
  'yield', 'typeof', 'instanceof', 'in', 'of', 'delete', 'void', 'null',
  'undefined', 'true', 'false', 'public', 'private', 'protected', 'readonly',
  'static', 'def', 'elif', 'lambda', 'pass', 'raise', 'with', 'as', 'not',
  'and', 'or', 'None', 'True', 'False', 'fn', 'let', 'mut', 'pub', 'struct',
  'impl', 'match', 'use', 'package', 'func', 'go', 'defer', 'select', 'chan',
]);
